...
urlpatterns = [
    ...
    # Usando app personalizado de contas 
    path('accounts/', include('accounts.urls', namespace='accounts')),

    # Core da aplicacação: index, sobre, contato, erro404
    ...
    #Inclui as urls do admin - administrativo
    path('', include('admin.urls', namespace='administra')),
